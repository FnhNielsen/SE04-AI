...
def main():
    ...
    fittest = genetic_algorithm(
        initial_population, queens_fitness.fitness_fn_negative, minimal_fitness)
    print('Fittest Individual: ' + str(fittest) + " fitness: " +
          str(queens_fitness.fitness_fn_negative(fittest)))
