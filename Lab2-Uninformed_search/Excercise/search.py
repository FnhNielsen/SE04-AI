...
'''
anatomy of the tuples:
name = ('Location','Status a', 'Status b')
'''
INITIAL_STATE = ('A', 'Dirty', 'Dirty')
GOAL_STATE = ('A', 'Clean', 'Clean')

STATE_SPACE = {
    ('A', 'Dirty', 'Dirty'): [('A', 'Dirty', 'Dirty'), ('A', 'Clean', 'Dirty'), ('B', 'Dirty', 'Dirty')],
    ('B', 'Dirty', 'Dirty'): [('B', 'Dirty', 'Dirty'), ('B', 'Clean', 'Dirty'), ('B', 'Dirty', 'Clean')],
